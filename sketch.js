...
function setup() {
  ...
  Engine.run(engine);
  ground = new Ground();
  stand1 = new Stand(390,400,1050,50);
  ...
  //level one
  blocks1 = new Block(360,175,30,40);
  blocks2 = new Block(390,175,30,40);
  blocks3 = new Block(420,175,30,40);
  blocks4 = new Block(450,175,30,40);
  blocks5 = new Block(480,175,30,40);
  //level two
  blocks6 = new Block(300,135,30,40);
  blocks7 = new Block(330,135,30,40);
  blocks8 = new Block(360,135,30,40);
  //top
  blocks9 = new Block(390,95,30,40);
